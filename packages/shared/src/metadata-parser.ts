...
const ALL_TOKENS_RE =
  /\s*(?:knowledge:true|completed-at:\d{4}-\d{2}-\d{2}|archived-at:\d{4}-\d{2}-\d{2}|archived:true|created-by:[\w-]+|built-by:[\w-]+|priority:(?:high|medium|low)|est:[\d.]+h?|due:\d{4}-\d{2}-\d{2}|@\w[\w-]*|#\w[\w-]*)\s*/gi
