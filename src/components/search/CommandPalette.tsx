  ...
  const items = useMemo(() => {
    ...
    for (const task of matchingTasks.slice(0, 10)) {
      result.push({
        ...
        icon: <CheckSquare className="size-4 text-amber-600" />,
        action: () => {
    ...
    const actions: PaletteItem[] = [
      {
        ...
        icon: <Code2 className="size-4 text-emerald-500" />,
        action: () => {
      ...
      },
      {
        ...
        icon: <Columns3 className="size-4 text-amber-600" />,
        action: () => {
          setActiveView('kanban')
          close()
        },
      },
      {
        ...
        type: 'action',
        label: 'New Board',
        icon: <Plus className="size-4 text-slate-500" />,
        action: () => {
      ...
      },
      {
        ...
        icon: sidebarOpen ? (
          ...
          <PanelLeftOpen className="size-4 text-slate-500" />
        ),
        action: () => {
